...
exports.deleteFacultyUser = exports.listFacultyUsers = exports.createFacultyUser = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
// Initialize Firebase Admin SDK
admin.initializeApp();
exports.createFacultyUser = functions.https.onRequest(async (req, res) => {
    // Set CORS headers
...
exports.listFacultyUsers = functions.https.onRequest(async (req, res) => {
    // Set CORS headers
    res.set("Access-Control-Allow-Origin", "*");
    ...
    try {
        ...
        const facultyUsers = listUsersResult.users.filter(user => user.customClaims && user.customClaims.faculty === true).map(user => ({
            uid: user.uid,
            email: user.email,
...
exports.deleteFacultyUser = functions.https.onRequest(async (req, res) => {
    // Set CORS headers
    res.set("Access-Control-Allow-Origin", "*");
